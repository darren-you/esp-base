...
2026-09-24 Base `master` 基线的公开依赖组合复验（保留当时事实）：普通固件的唯一 Component Manager 声明及重新生成的 `firmware/dependencies.lock` 精确解析 `esp-mqtt@5bff093646d8db810d64c50c39edc004e78bf40c`、`esp-frp@3a40a2c06580232bbe23cb981eeb21c4d14d33c1`、`esp-ota@3c3f72b823ce856b02f838fef17db1368e6d5448`，锁文件 SHA-256 为 `c170788e295f52321a132e6f5b42fdea389c180a5643528a745e6aad22342fc8`。SDK 使用公开 `esp-idf@578cf89c343e388db43ba1f4ddcd602fedcb763c` 与 `esp-lwip@2758df4cd3666b3b2a5b53830148379326425c0d`。以下较早条目保留各自执行时的依赖与镜像事实，不代表当前锁版本。
