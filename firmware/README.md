...
[嵌入式标准](https://github.com/darren-you/darren-space/blob/master/harness/docs/workspace/standards/embedded_firmware/embedded_firmware_golden_path.md)。测试在 `tests/`，公开主机调用示例在固件根之外的 [tools/](../tools/README.md)。Component Manager 依赖由 `dependencies.lock` 固定；`mqtt` 唯一来源是公开 `esp-mqtt@113bdef20d862a1bf094fd3cdd833f641ab7aa64`，`esp_ota` 唯一来源是公开 `esp-ota@feb6ef255d55d6e29d7904b87be92f571eb00317`，`esp_frp` 唯一来源是公开 `esp-frp@9158b7f2e2c555a14636aed26b5189902152d19e`。host tests 使用同一已解析 cJSON、`eota.h` 与 `esp_frp.h`，不读取相邻仓。
