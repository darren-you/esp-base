...
2026-09-26 固定 SDK 对当前工作树的普通 C3 全量构建通过，镜像 957696 字节、SHA-256 `88c58e872cedf1419a730569681673bd4e9c2617084a5bfce37e9f6b1ddd887f`，生成配置和分区仍为原 C3 基线；Base host ASan/UBSan 全套、离线预检 9/9、串口伪终端 5/5 通过。独立 `esp32` 构建在布局/OTA/签名链守卫处按预期退出，没有产生 ESP32 Base 镜像。详细输入与范围见[开发检查点](docs/operations/development-checkpoint.md)；P2-08 仍在进行中。
